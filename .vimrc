...
func SetComment()
   " call setline(1,"") 
    ...
    call append(line(".")+18, "#define ra(e, u) for(int e=head[(u)];e!=-1;e=E[e].next)")
    call append(line(".")+19, "using namespace std;")
    call append(line(".")+20, "")
    call append(line(".")+21, "typedef pair<int, int >PII;")
    call append(line(".")+22, "typedef long long int64;")
    call append(line(".")+23, "const double PI  = acos(-1.0);")
    call append(line(".")+24, "const int INF = 0x3f3f3f3f;")
    call append(line(".")+25, "const double eps = 1e-8;")
    call append(line(".")+26, "")
    call append(line(".")+27, "int main() {")
    call append(line(".")+28, "")
    call append(line(".")+29, "")
